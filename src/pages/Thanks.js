...
function Thanks() {
  return (
    <div className="flex flex-col space-y-2 items-center text-center my-2">
      <svg
        id="c9533a1a-3341-4132-b58a-1916f0ec6876"
        data-name="Layer 1"
        className="sm:w-2/5 flex"
      ...
      >
        ...
        <path
          ...
          fill="#5c3d53"
        />
        <circle cx={407.84} cy={43.7} r={1.45} opacity={0.2} />
        <circle cx={438.2} cy={47.31} r={1.45} opacity={0.2} />
        <path
      ...
      <span className="sm:text-3xl text-2xl font-medium capitalize">
        Thanks for ordering from shopkart
      </span>
      <div className="flex flex-row space-x-2 justify-between items-center text-sm sm:text-lg capitalize">
        <Link
          to="/"
          className="bg-blue-500 hover:bg-blue-700 text-white font-light sm:py-4 sm:px-6 px-2 py-2 rounded-lg inline-block shadow-inner"
        >
          Back To Homepage
        </Link>
        <Link
