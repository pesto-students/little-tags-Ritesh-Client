...
function Footer() {
  return (
    <div className="bg-gray-100">
      <div
        className="flex justify-between items-center pb-5 px-3 m-auto pt-5 text-gray-800 text-sm flex-col sm:flex-row
      ...
      >
        ...
        <div className="flex flex-row mt-2">
          ...
          <a
            href="https://github.com/pesto-students/little-tags-Ritesh-Client"
            target="blank"
            className="w-6 mx-1"
          >
            <svg
