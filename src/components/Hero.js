      ...
      <div className="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
        <div className="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="hero-text col-span-6">
            <h1 className="pt-8 font-bold text-2xl sm:text-4xl max-w-xl text-gray-900 leading-tight">
            ...
            <div className="get-app flex space-x-5 mt-10 justify-center md:justify-start">
              <button className="apple bg-white shadow-md px-3 py-2 rounded-lg items-center space-x-4 sm:flex hidden duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                <div className="logo">
                  <svg
                    className="w-6 h-6"
                ...
                <div className="text">
                  ...
                  >
                    <FormattedMessage id="AppleDownloadTextOne" />
                    {/* Download on the */}
                  </p>
                  <p className=" text-xs font-semibold text-gray-900">
                    <FormattedMessage id="AppleDownloadTextTwo" />
                  </p>
                </div>
              </button>
              <button className="google bg-white shadow-md px-3 py-2 rounded-lg items-center space-x-4 sm:flex hidden duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                <div className="image">
                  <svg
                    className="w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="text">
                  <p
                    ...
                    style={{ fontSize: "0.5rem" }}
                  >
                    <FormattedMessage id="GoogleDownloadTextOne" />
                  </p>
                  <p className="text-xs font-semibold text-gray-900">
                    <FormattedMessage id="GoogleDownloadTextTwo" />
                  </p>
                </div>
              </button>
            </div>
          ...
          <div className="hero-image col-span-6 -mt-20 sm:mt-0">
            <svg
              id="Layer_1"
              data-name="Layer 1"
              xmlns="http://www.w3.org/2000/svg"
