        ...
        >
          ...
          >
            <button
              ...
              className="block mt-4 lg:inline-block lg:mt-0 hover:text-white px-4 py-2 rounded hover:bg-blue-700"
            >
          ...
          <div className="flex flex-row justify-between items-center">
            <div className="text-md text-black-700 lg:flex-grow sm:flex">
              ...
              >
                ...
                <p className="text-md font-normal text-center sm:hidden">
                  Cart
                </p>
              </button>
              <div
